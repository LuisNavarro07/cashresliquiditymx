...
coefplot (m1, `coef1') (m2, `coef2') (m3, `coef3') (m4, `coef4') , keep($independent) labels $legendcoef title("OLS Estimates", pos(11)) name(ols_coef, replace) $coefopts
coefplot (iv1, `coef1') (iv2, `coef2') (iv3, `coef3') (iv4, `coef4') , keep($independent) labels $legendcoef title("2SLS IV Estimates", pos(11)) name(iv_coef, replace) $coefopts
...
list
/// Export Full Table 
texsave using "${ao}\Regression_StDebt_$model.tex", autonumber hlines(1 4 9) nofix replace marker(tab:Regression_StDebt) title("`title'") footnote("`fn'") varlabels 
